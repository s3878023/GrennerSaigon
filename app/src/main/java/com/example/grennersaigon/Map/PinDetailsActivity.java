...
//                            if (siteMembers != null && !siteMembers.isEmpty()) {
//                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, siteMembers);
...
//                            }
    ...
    private void joinSite() {
        ...
        if (currentUser != null) {
            ...
            // Fetch siteMembers from the document
            FirebaseFirestore db = FirebaseFirestore.getInstance();
            db.collection("pins").document(documentId)
                    .get()
                    .addOnCompleteListener(task -> {
    ...
    private void showEditDialog() {
        ...
        dialogBuilder.setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                updatePinInformation(updatedSiteName, updatedSiteDescription);
            }
        });
    ...
    private void updatePinInformation(String updatedSiteName, String updatedSiteDescription) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
        db.collection("pins").document(documentId)
                .update("siteName", updatedSiteName, "siteDescription", updatedSiteDescription)
                .addOnSuccessListener(aVoid -> {
